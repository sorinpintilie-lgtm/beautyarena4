...
### Culori primare
```css
/* Pentru CTA-uri principale, link-uri, stări active */
--color-beauty-pink: #ff69b4
--color-beauty-rose: #f43f5e
```

### Culori secundare
```css
/* Pentru badge-uri, evidențieri, acțiuni secundare */
--color-beauty-purple: #8b5cf6
--color-beauty-gold: #f59e0b
```
...
|---------|---------|-----------|
| CTA primar | gradient beauty-pink → beauty-rose | Butoane de acțiune principală |
...
| Link-uri | beauty-pink, hover: beauty-rose | Text clickabil |
| Badge-uri | fundal beauty-purple/10, text beauty-purple | Indicatori de status |
...
<div className="card-beauty group">
  {/* Imagine */}
  <div className="relative aspect-square bg-gradient-to-br from-pink-50 to-purple-50 rounded-lg mb-4">
    <img src={product.image} alt={product.name} className="object-cover" />
    
    {/* Badge-uri */}
    <div className="absolute top-2 left-2 flex flex-col gap-1">
      {product.isNew && <Badge variant="purple">Nou</Badge>}
      {product.onSale && <Badge variant="rose">Reducere</Badge>}
    </div>
...
// Buton primar
className="bg-gradient-to-r from-beauty-pink to-beauty-rose text-white px-6 py-3 rounded-full font-medium hover:from-beauty-rose hover:to-beauty-pink transition-all duration-300 transform hover:scale-105"
...
// Badge
className="inline-flex items-center px-3 py-1 bg-beauty-purple/10 text-beauty-purple text-sm font-medium rounded-full"
```
