...
const CheckoutPage = () => {
  ...
  const shippingMethods = [
    { id: 'standard', name: 'Livrare standard', duration: '3-5 zile lucrătoare', price: 15 },
    { id: 'express', name: 'Livrare express', duration: '1-2 zile lucrătoare', price: 30 },
    { id: 'sameday', name: 'Livrare în aceeași zi', duration: 'Astăzi', price: 50 },
  ];
