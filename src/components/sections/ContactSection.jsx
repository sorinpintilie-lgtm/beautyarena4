      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-4 py-2 bg-beauty-purple/10 rounded-full border border-beauty-purple/20 mb-6">
            <MessageCircle className="w-4 h-4 text-beauty-purple mr-2" />
            <span className="text-sm font-medium text-beauty-purple">Contactează-ne</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {contactInfo.map((info, index) => (
                <div key={index} className="card-beauty text-center">
                  <div className="w-12 h-12 bg-gradient-to-br from-beauty-pink to-beauty-purple rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            {/* Quick Contact */}
            <div className="bg-gradient-to-r from-beauty-navy to-beauty-purple rounded-2xl p-6 text-white">
