              ...
              {specialists.map((specialist) => (
                ...
                >
                  <div className="text-center">
                    <div className="w-16 h-16 bg-gradient-to-br from-beauty-pink to-beauty-purple rounded-full flex items-center justify-center mx-auto mb-3">
    ...
    <section id="booking" className="section-padding bg-gradient-to-b from-beauty-pink/5 to-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center px-4 py-2 bg-beauty-gold/10 rounded-full border border-beauty-gold/20 mb-6">
            <Calendar className="w-4 h-4 text-beauty-gold mr-2" />
            <span className="text-sm font-medium text-beauty-gold">Programează-te</span>
          </div>
