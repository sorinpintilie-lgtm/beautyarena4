      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-4 py-2 bg-beauty-purple/10 rounded-full border border-beauty-purple/20 mb-6">
            <ShoppingCart className="w-4 h-4 text-beauty-purple mr-2" />
            <span className="text-sm font-medium text-beauty-purple">Produse premium</span>
          </div>
        ...
        {/* Products Grid/List */}
        <div className={`${viewMode === 'grid' ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3' : 'space-y-6'} gap-6`}>
            ...
            >
              ...
              <div className={`${viewMode === 'list' ? 'w-32 h-32 flex-shrink-0' : 'w-full h-48'} relative bg-gradient-to-br from-pink-50 to-purple-50 rounded-lg flex items-center justify-center mb-4 ${viewMode === 'list' ? 'mb-0 mr-4' : ''}`}>
                ...
                <div className="absolute top-2 left-2 flex flex-col space-y-1">
                  ...
                  {product.isOnSale && (
                    <span className="bg-beauty-rose text-white text-xs px-2 py-1 rounded-full">REDUCERE</span>
                  )}
                  {!product.inStock && (
                ...
                <button className="absolute top-2 right-2 p-2 bg-white/80 rounded-full hover:bg-white transition-colors duration-300">
                  <Heart className="w-4 h-4 text-gray-600 hover:text-beauty-rose" />
                </button>
              </div>
