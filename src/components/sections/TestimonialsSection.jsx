      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-4 py-2 bg-beauty-rose/10 rounded-full border border-beauty-rose/20 mb-6">
            <Star className="w-4 h-4 text-beauty-rose mr-2" />
            <span className="text-sm font-medium text-beauty-rose">Ce spun clienții</span>
          </div>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-elegant font-bold text-gray-900 mb-6">
            Poveștile de
            <span className="block gradient-text">Succes</span>
          </h2>
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-beauty-pink to-beauty-purple rounded-full flex items-center justify-center mr-3">
              ...
              <div className="flex items-center mb-3">
                {[...Array(testimonial.rating)].map((_, i) => (
                  <Star key={i} className="w-4 h-4 text-beauty-gold fill-current" />
                ))}
        ...
        <div className="bg-gradient-to-r from-beauty-pink to-beauty-purple rounded-2xl p-8 lg:p-12 text-white text-center">
          <div className="max-w-4xl mx-auto">
            <Quote className="w-12 h-12 text-white/30 mx-auto mb-6" />
            <blockquote className="text-xl lg:text-2xl font-elegant leading-relaxed mb-6">
            ...
            <div className="flex items-center justify-center">
              ...
              <div className="text-left">
                <div className="font-semibold text-lg">Cristina Popescu</div>
                <div className="text-white/80">Client fidel de 3 ani</div>
