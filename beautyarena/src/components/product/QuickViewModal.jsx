            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <div className="aspect-square bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl flex items-center justify-center relative">
                  ...
                  <div className="absolute top-4 left-4 flex flex-col gap-2">
                    {product.isNew && (
                      <span className="bg-beauty-pink text-white text-xs px-3 py-1 rounded-full font-medium">
                        Nou
                      </span>
                    )}
                    {product.discount > 0 && (
                      <span className="bg-beauty-pink-dark text-white text-xs px-3 py-1 rounded-full font-medium">
                        -{product.discount}%
                      </span>
                    )}
                  </div>
              ...
              <div className="space-y-4">
                ...
                <Link
                  ...
                  onClick={onClose}
                  className="flex items-center justify-center gap-2 text-beauty-pink hover:text-beauty-pink-dark transition-colors font-medium text-sm"
                >
