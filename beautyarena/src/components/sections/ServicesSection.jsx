      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-elegant font-bold text-gray-900 mb-6">
            Experimentează
            <span className="block text-black">excelența în frumusețe</span>
          </h2>
            ...
            return (
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  {/* Action Button */}
                  <button className="w-full mt-4 btn-secondary flex items-center justify-center group-hover:bg-beauty-pink group-hover:text-gray-900 transition-all duration-300">
        ...
        <div className="text-center mt-16">
          <div className="relative bg-beauty-pink rounded-2xl p-8 text-white overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <button className="bg-[#FFB6A3] text-gray-800 px-4 md:px-8 py-2 md:py-3 rounded-full font-semibold hover:bg-[#FFAB9D] transition-colors duration-300 flex items-center mx-auto text-sm md:text-base">
                <Calendar className="w-4 h-4 md:w-5 md:h-5 mr-1 md:mr-2" />
                <span className="whitespace-nowrap">Programează consultația gratuită</span>
