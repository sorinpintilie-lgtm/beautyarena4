      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-4">
            <div className="aspect-square bg-beauty-pink/10 rounded-2xl flex items-center justify-center relative overflow-hidden group">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {relatedProducts.map(relatedProduct => (
                ...
                >
                  <div className="aspect-square bg-beauty-pink/10 rounded-lg mb-3 flex items-center justify-center">
