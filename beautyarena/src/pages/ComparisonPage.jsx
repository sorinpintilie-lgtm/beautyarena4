          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="p-4 text-left text-sm font-medium text-gray-700 bg-gray-50 sticky left-0 z-10 bg-white">
                  Caracteristică
                </th>
                {comparisonItems.map(product => (
                  <th key={product.id} className="p-4 min-w-[200px] sm:min-w-[250px]">
                    <div className="space-y-4">
                      {/* Product Image */}
                      <div className="relative">
                        <Link to={`/product/${product.slug}`}>
                          <div className="aspect-square bg-beauty-pink/10 rounded-lg flex items-center justify-center">
