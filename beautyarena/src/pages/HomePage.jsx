...
const HomePage = () => {
  return (
    <>
      <SEO
        title="Salon Beauty Arena - Produse Premium de Frumusețe și Servicii Profesionale"
        description="Descoperă produse premium de frumusețe de la brand-uri de top și servicii profesionale de frumusețe. Cumpără de la L'Oréal, Maybelline, NYX, The Ordinary și multe altele la Salon Beauty Arena."
