          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {wishlistItems.map(product => (
              <div key={product.id} className="card-beauty group relative">
                ...
                >
                  <Trash2 className="w-4 h-4 text-gray-600 hover:text-beauty-pink" />
                </button>

                {/* Product Image */}
                <Link to={`/product/${product.slug}`} className="block">
                  <div className="aspect-square bg-beauty-pink/10 rounded-lg mb-4 flex items-center justify-center">
